...
import com.example.demo_jdbc.connection.ConnectionUsers;
...
import static com.example.demo_jdbc.connection.ConnectionUsers.getConnection;
...
public class UserDAO implements IUserDAO {
    ...
    //----------------------------------------------------------------
    public static final String CALL_GET_ALL_USERS = "{CALL get_all_user()}";
    public static final String CALL_UPDATE_USER = "{CALL update_users(?,?,?,?)}";
    public static final String CALL_DELETE_USER = "{CALL delete_users_by_id(?)}";
    //----------------------------------------------------------------
    ...
    public List<User> searchUser(String country) {
        ...
        try (Connection conn = getConnection();
             PreparedStatement preparedStatement = conn.prepareStatement(SELECT_USERS_BY_COUNTRY);
        ) {
    ...
    public void addUserTransaction(User user, int[] permision) {
        ...
        try {
            ...
            System.out.println("rs gen key" + rs);
            int userId = 0;
            if (rs.next()) {
                userId = rs.getInt(1);
            }
...
//            psUpdate.setBigDecimal(2, new BigDecimal(999.99));
    ...
    public List<User> callGetAllUsers() {
        List<User> users = new ArrayList<>();
        try (Connection conn = getConnection();
             CallableStatement statement = conn.prepareCall(CALL_GET_ALL_USERS);
        ) {
    ...
    @Override
    public boolean callUpdateUser(User user) throws SQLException {
        boolean rowUpdated;
        try (Connection conn = getConnection();
             CallableStatement callableStatement = conn.prepareCall(CALL_UPDATE_USER);
        ) {
    ...
    @Override
    public boolean callDeleteUser(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection conn = getConnection();
             CallableStatement statement = conn.prepareCall(CALL_DELETE_USER);
        ) {
